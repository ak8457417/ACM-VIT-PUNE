    ...
    <section className="relative w-full py-32 overflow-hidden ">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-12 lg:gap-24">
          ...
          >
            <div className="bg-black/60 backdrop-blur-xl border border-green-500/30 p-8 md:p-12 rounded-[2rem] shadow-[0_0_80px_rgba(34,197,94,0.15)] relative overflow-hidden flex flex-col justify-center w-full">
